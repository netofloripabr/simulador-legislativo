...
Gerado em 2026-08-28 por `ferramentas/conferir_rrc.py`. Cruza `am-2026-provisorio.js` (baseado em Atas de Convenção) contra o Registro de Candidatura (RRC) oficial do TSE, por número dentro do mesmo cargo.
...
Resumo: **467** confirmados, **0** divergência(s) de partido, **6** candidato(s) no RRC sem entrada correspondente no nosso arquivo.
...
| Vice-Governador | Leonardo Balbi Da Silva | 18 | 767-psol-rede-executiva.pdf |
...
| Senador (1º suplente) | Laynara Cristina Leite Prestes | 181 | 767-psol-rede-executiva.pdf |
...
| Senador (1º suplente) | Renan Nogueira Rotondano | 500 | 767-psol-rede-executiva.pdf |
| Senador (1º suplente) | Sandra Backsmann Braga | 155 | 883-mdb-executiva.pdf |
| Senador (2º suplente) | André Monteiro Da Silva | 181 | 767-psol-rede-executiva.pdf |
...
| Senador (2º suplente) | Jander Dos Santos Muniz | 500 | 767-psol-rede-executiva.pdf |
