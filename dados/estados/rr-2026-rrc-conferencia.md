...
Gerado em 2026-08-28 por `ferramentas/conferir_rrc.py`. Cruza `rr-2026-provisorio.js` (baseado em Atas de Convenção) contra o Registro de Candidatura (RRC) oficial do TSE, por número dentro do mesmo cargo.
...
Resumo: **401** confirmados, **0** divergência(s) de partido, **8** candidato(s) no RRC sem entrada correspondente no nosso arquivo.
...
| Senador | 13 | 15 | 15 |
| Deputado Federal | 106 | 128 | 115 |
| Deputado Estadual | 243 | 288 | 266 |
| Senador (1º suplente) | 14 | 21 | 0 |
| Senador (2º suplente) | 15 | 22 | 0 |
