...
Gerado em 2026-08-28 por `ferramentas/conferir_rrc.py`. Cruza `ap-2026-provisorio.js` (baseado em Atas de Convenção) contra o Registro de Candidatura (RRC) oficial do TSE, por número dentro do mesmo cargo.
