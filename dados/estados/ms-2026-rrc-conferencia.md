...
Gerado em 2026-09-01 por `ferramentas/conferir_rrc.py`. Cruza `ms-2026-provisorio.js` (baseado em Atas de Convenção) contra o Registro de Candidatura (RRC) oficial do TSE, por número dentro do mesmo cargo.
...
Resumo: **390** confirmados, **0** divergência(s) de partido, **9** candidato(s) no RRC sem entrada correspondente no nosso arquivo.
...
| Senador | 10 | 10 | 10 |
| Deputado Federal | 124 | 128 | 121 |
| Deputado Estadual | 252 | 274 | 251 |
...
| Deputado Federal | 1888 | JOÃO VITOR PIMENTEL NUNES | FEDERAÇÃO PSOL REDE(PSOL/REDE) |
