# Conferência — resultado oficial 2022, SE (Deputado Estadual, Deputado Federal, Senador)

Gerado por `ferramentas/tratar_resultados_2022.py`, a partir de `votacao_candidato_munzona_2022_SE.csv`
