...
Gerado em 2026-08-28 por `ferramentas/conferir_rrc.py`. Cruza `ac-2026-provisorio.js` (baseado em Atas de Convenção) contra o Registro de Candidatura (RRC) oficial do TSE, por número dentro do mesmo cargo.
...
Resumo: **375** confirmados, **0** divergência(s) de partido, **3** candidato(s) no RRC sem entrada correspondente no nosso arquivo.
