...
Gerado em 2026-08-28 por `ferramentas/conferir_rrc.py`. Cruza `ce-2026-provisorio.js` (baseado em Atas de Convenção) contra o Registro de Candidatura (RRC) oficial do TSE, por número dentro do mesmo cargo.
...
Resumo: **734** confirmados, **0** divergência(s) de partido, **9** candidato(s) no RRC sem entrada correspondente no nosso arquivo.
...
| Senador | 8 | 10 | 10 |
| Deputado Federal | 292 | 325 | 313 |
| Deputado Estadual | 374 | 414 | 399 |
...
| Vice-Governador | Gabriella Pequeno Costa Gomes De Aguiar | 13 | 705-pt-pc-do-b-pv-convencao.pdf |
...
| Vice-Governador | Roberto Claudio Rodrigues Bezerra | 45 | 813-44-uniao-11-pp-executiva.pdf |
