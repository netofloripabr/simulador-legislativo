...
- **Auditoria completa de corte de texto em largura real de celular (13/08/2026)**, disparada pela correção da tag de viewport acima. Quatro pontos achados e corrigidos, todos testados ao vivo em 375px:
  ...
  - Selo "sobra · rodada X/Y" vazando ~48-50px pra fora do card (container dos selos tinha `flex-shrink:0`, nunca encolhia pra quebrar linha). Corrigido pra `min-width:0`, agora quebra embaixo do selo "eleito · média" quando não cabe
